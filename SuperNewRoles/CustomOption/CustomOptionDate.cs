    ...
    public class CustomOptions
    {
        ...
        public static void Load()
        {
            ...
            */
            ...
            ArsonistOption = new CustomRoleOption(411, false, CustomOptionType.Neutral, "ArsonistName", RoleClass.Arsonist.color, 1);
            ArsonistPlayerCount = CustomOption.Create(412, false, CustomOptionType.Neutral, "SettingPlayerCountName", CrewPlayers[0], CrewPlayers[1], CrewPlayers[2], CrewPlayers[3], TeleportingJackalOption);
            ArsonistCooldown = CustomOption.Create(413, false, CustomOptionType.Neutral, "ArsonistCoolDownSetting", 30f, 2.5f, 60f, 2.5f, ArsonistOption, format: "unitSeconds");
            ArsonistDuration = CustomOption.Create(414, false, CustomOptionType.Neutral, "TeleporterTeleportTimeSetting", 10f, 1f, 20f, 0.5f, ArsonistOption, format: "unitSeconds");
